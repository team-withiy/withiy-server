...
public class AdminFacadeTest {
    ...
    void getActiveContents_success() {
        ...
        when(placeService.getActivePlacesByCategoryAndKeyword(category, keyword)).thenReturn(List.of(place));
        when(placeService.getBookmarkCount(place)).thenReturn(10L);
        when(albumService.getAlbum(place)).thenReturn(album1);
        ...
        assertThat(result.getPlaces().get(0).getPhotoUrls()).containsExactly("https://image.com/photo1.jpg");
        ...
        assertThat(result.getCourses().get(0).getPhotoUrls()).containsExactly("https://image.com/photo1.jpg");
    }
