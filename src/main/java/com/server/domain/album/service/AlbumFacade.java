...
public class AlbumFacade {
    ...
    public AlbumPageResponse getAlbums(User user, int page, int size, String order)
            throws Exception {
        Page<Album> albumPage = albumService.getAlbums(user.getCouple(), page, size, order);
    ...
    public AlbumDetailResponse getAlbum(User user, Long albumId) {
        Album album = albumService.getAlbum(user.getCouple(), albumId);
    ...
    public void writeComment(User user, AlbumCommentRequest request) {
        Album album = albumService.getAlbum(user.getCouple(), request.getAlbumId());
