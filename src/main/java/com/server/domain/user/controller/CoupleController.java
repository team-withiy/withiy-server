...
public class CoupleController {
	...
	@GetMapping
	@Operation(summary = "[사용자] 커플 정보 조회", description = "현재 로그인한 사용자의 커플 관계 정보를 조회합니다.")
	...
	@ResponseStatus(HttpStatus.OK)
	@DeleteMapping
	@Operation(summary = "[사용자] 커플 연결 해제", description = "현재 로그인한 사용자의 커플 관계를 해제합니다.")
	...
	@ResponseStatus(HttpStatus.OK)
	@PostMapping("/restore")
	@Operation(summary = "[사용자] 커플 연결 복구", description = "현재 로그인한 사용자의 커플 관계를 복구합니다.")
	...
	@Operation(summary = "[사용자] 처음 만난 날짜 설정", description = "이미 연결된 커플의 처음 만난 날짜를 설정하거나 변경합니다.")
