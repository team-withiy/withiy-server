...
public enum BadgeType {
    ...
    WIDI_COUPLE("위디커플", "커플 연결을 하면 받을 수 있어요!", "하트 머리핀 or 머리띠"),
    WIDI_MEMORY("위디추억", "첫 추억을 위디와 함께했어요~", "폴라로이드 사진 배경 or 어깨에 작은 카메라"),
    WIDI_REGULAR("위디단골", "일주일 내내 위디에 들렀어요. (🙋‍♀️ 한 명만 매일 들러도 배지가 지급돼요!)", "리본 목도리"),
    WIDI_HOLIC("위디홀릭", "한 달 동안 매일 위디에 접속했어요. (🫶 두 사람 모두 매일 접속해야 받아요!)", "반짝이는 왕관 or 별빛 후광"),
    ...
    WIDI_EXPLORER("위디탐험가", "벌써 20개의 추억이라니! (🫶 두 사람 합산 기준이에요)", "모험가 모자"),
    ...
    BadgeType(String displayName, String label, String item) {
