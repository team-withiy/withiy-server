...
public enum CoupleErrorCode implements ErrorCode {
    ...
    COUPLE_ALREADY_CONNECTED(HttpStatus.BAD_REQUEST.value(), "Couple is currently connected and not in deleted state."),
    ...
    INVALID_COUPLE_ID(HttpStatus.BAD_REQUEST.value(), "Provided couple ID does not match the user's couple.");
