...
public enum CoupleErrorCode implements ErrorCode {
    ...
    ALREADY_CONNECTED(HttpStatus.BAD_REQUEST.value(), "User is already connected as a couple."),
    ...
    COUPLE_ALREADY_ACTIVE(HttpStatus.BAD_REQUEST.value(), "Couple is already active.");
